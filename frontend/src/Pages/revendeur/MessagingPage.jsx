    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-blue-600 to-cyan-600 px-4 py-3 font-bold text-white shadow-xl transition-all hover:-translate-y-0.5 hover:from-blue-700 hover:to-cyan-700 sm:w-auto sm:px-6"
        >
      ...
      <div className="min-h-[70vh] overflow-hidden rounded-xl border border-slate-200 bg-white sm:h-[calc(100vh-220px)]">
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 sm:p-6">
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 flex flex-col gap-3 border-b border-slate-200 bg-white p-4 sm:flex-row sm:items-center sm:justify-between sm:p-6">
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900">📝 Nouveau message</h2>
          <button
            onClick={onClose}
