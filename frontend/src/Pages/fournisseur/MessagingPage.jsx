...
function FournisseurMessagingPage() {
  ...
  const conversations = [
    ...
    },
    {
      ...
      city: 'Monastir',
      lastMessage: 'Question sur la facture #2024-089',
      timestamp: 'Il y a 2h',
      unread: 3,
      online: true,
      urgent: true,
      archived: false,
      messages: [
        { id: 1, sender: 'them', text: 'Question sur la facture #2024-089', time: '11:30' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-purple-600 to-indigo-600 px-4 py-3 font-bold text-white shadow-lg transition-all hover:-translate-y-0.5 hover:from-purple-700 hover:to-indigo-700 sm:w-auto sm:px-5"
          >
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-blue-600 to-cyan-600 px-4 py-3 font-bold text-white shadow-lg transition-all hover:-translate-y-0.5 hover:from-blue-700 hover:to-cyan-700 sm:w-auto sm:px-5"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="min-h-[72vh] overflow-hidden rounded-xl border border-slate-200 bg-white sm:h-[calc(100vh-260px)]">
        <div className="grid h-full grid-cols-1 md:grid-cols-12">
          
          {/* LEFT SIDEBAR - Conversations List */}
          <div className={`${selectedConversation ? 'hidden md:flex' : 'flex'} min-h-0 flex-col border-b border-slate-200 md:col-span-4 md:border-b-0 md:border-r`}>
          ...
          <div className={`${selectedConversation ? 'flex' : 'hidden md:flex'} min-h-0 flex-col md:col-span-8`}>
            ...
            {!selectedConversation ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
                ...
                <button
                  onClick={() => setShowComposeModal(true)}
                  className="px-4 sm:px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors"
                >
                  Nouveau message
                </button>
              </div>
              ...
              <>
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                      <button
                        ...
                        className="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 transition-colors hover:bg-slate-100 md:hidden"
                ...
                {/* Messages Area */}
                <div className="min-h-0 flex-1 overflow-y-auto bg-slate-50 p-4 sm:p-6 space-y-4">
                  {selectedConversation.messages.map((msg) => (
                    <div
                      key={msg.id}
                      className={`flex ${msg.sender === 'me' ? 'justify-end' : 'justify-start'}`}
                    >
                      <div className={`max-w-[82%] sm:max-w-[70%] ${msg.sender === 'me' ? 'order-2' : 'order-1'}`}>
                ...
                <div className="p-4 border-t border-slate-200 bg-white">
                  <div className="flex items-end gap-2 sm:gap-3">
                    ...
                    <button className="rounded-lg p-2.5 transition-colors hover:bg-slate-100 flex-shrink-0 sm:p-3">
                    ...
                    <button
                      ...
                      className="rounded-lg bg-gradient-to-r from-blue-600 to-cyan-600 p-2.5 text-white transition-all hover:from-blue-700 hover:to-cyan-700 disabled:cursor-not-allowed disabled:opacity-50 flex-shrink-0 sm:p-3"
                    >
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 sm:p-6">
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 flex flex-col gap-3 border-b border-slate-200 bg-white p-4 sm:flex-row sm:items-center sm:justify-between sm:p-6">
